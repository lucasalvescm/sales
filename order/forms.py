...
class OrderForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = [
            ...
            'sale_price', 'delivered', 'canceled', 'delivered_date'
        ]
        widgets = {
            'delivered_date': forms.DateInput(attrs={'class': 'datepicker', 'id': 'data_input'})
        }
    def __init__(self,*args,**kwargs):
        ...
        self.fields['delivered_date'].widget.attrs['style'] = 'width:20%'
